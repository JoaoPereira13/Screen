...
public class Demo_old extends AppCompatActivity implements PermissionsListener {
    ...
    private Runnable runnable = new Runnable() {
        @Override
        public void run() {
            Demo_old.this.runOnUiThread(new Runnable() {
                /** Loop function */
                public void run() {
    ...
    private void refreshUserPosition(){
        ...
        if(userMarker == null){
            /** Get the user icon */
            IconFactory iconFactory = IconFactory.getInstance(Demo_old.this);
    ...
    private void refreshNeighPosition(String id) {
        ...
        if(isOnOpposingLane(userData.getCourseDouble(), neighData.getCourseDouble())){
            ...
            if(neighData.getId().equals("657")){
                iconFactory = IconFactory.getInstance(Demo_old.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(MapboxMap mapboxMap) {
                ...
                permissionsManager = new PermissionsManager(Demo_old.this);
                if (!PermissionsManager.areLocationPermissionsGranted(Demo_old.this)) {
                    permissionsManager.requestLocationPermissions(Demo_old.this);
                } else{
                    init();
                }
            }
